  ...
  return {
    ...
    async configResolved(config) {
      const prettierOptions =
        (await prettier_1.default.resolveConfig(config.root)) || {}
      cacheConfig = {
        ...config,
    ...
    handleHotUpdate(context) {
      if (!(0, util_1.isCSSModuleRequest)(context.file)) return
    ...
    transform(code, id) {
      ...
      if (!(0, util_1.isCSSModuleRequest)(fileName)) return { code }
