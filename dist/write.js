...
exports.formatExportTypeFileName =
  exports.formatWriteFileName =
  exports.formatExportType =
  exports.writeToFile =
    void 0
...
const writeToFile = async (
  ...
  if (globalOutFile) {
    const relativePath = (0, util_1.getRelativePath)(
      path_1.default.dirname(fileName),
      path_1.default.dirname(globalOutFile)
    )
    const exportTypeFileName = (0, exports.formatExportTypeFileName)(
      globalOutFile
    )
  ...
  const prettierdOutputFileString = prettier_1.default.format(
    outputFileString,
    prettierOptions
  )
  fs_1.default.writeFile(
    (0, exports.formatWriteFileName)(fileName),
...
const formatWriteFileName = (file) =>
  `${file}${file.endsWith('d.ts') ? '' : '.d.ts'}`
exports.formatWriteFileName = formatWriteFileName
const formatExportTypeFileName = (file) =>
  path_1.default.basename(file.replace('.ts', ''))
