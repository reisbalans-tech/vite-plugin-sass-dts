...
export declare const getRelativePath: (from: string | undefined, to: string | undefined) => string;
...
export declare const collectionToObj: <V>(collection: Record<string, V>[]) => Record<string, V>;
