    ...
    fs_1.default.readFile(fileName, async (err, file) => {
      if (err) {
        ...
        try {
          ...
          const classNameKeys = (0, extract_1.extractClassNameKeys)(
            postcss_js_1.default.objectify(
              postcss_1.default.parse(css.localStyle)
            ),
            toParseCase
          )
          ;(0, write_1.writeToFile)(
          ...
          if (!!css.globalStyle && option.global?.generate) {
            const globalClassNameKeys = (0, extract_1.extractClassNameKeys)(
              postcss_js_1.default.objectify(
                postcss_1.default.parse(css.globalStyle)
              ),
              toParseCase
            )
            ;(0, write_1.writeToFile)(
